...
public class SpatemMessage extends InterchangeMessage {
    String id;//o
    String name;//o

    public SpatemMessage(String publisherName, String publisherId, String originatingCountry, 
            String protocolVersion,double latitude, double longitude, String[] quadTree) {
        super(publisherName, publisherId, originatingCountry, protocolVersion, MessageType.SPATEM, latitude, longitude, quadTree);
    }

    public SpatemMessage(String publisherName, String publisherId, String originatingCountry, 
            String protocolVersion,double latitude, double longitude) {
        super(publisherName, publisherId, originatingCountry, protocolVersion, MessageType.SPATEM, latitude, longitude, new String[]{Quadtree.latLonToQuadtree(latitude, longitude, 18)});
    }
